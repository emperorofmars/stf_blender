...
def _draw_component(layout: bpy.types.UILayout, context: bpy.types.Context, component_ref: PSTF_Component_Ref, context_object: Any, component: STFEXP_Collider_Capsule):
...
def _set_component_instance_standin(context: bpy.types.Context, component_ref: PSTF_Component_Ref, context_object: Any, component: STFEXP_Collider_Capsule, standin_component: STFEXP_Collider_Capsule):
...
def _serialize_component_instance_standin_func(context: PSTF_ExportContext, component_ref: PSTF_Component_Ref, standin_component: STFEXP_Collider_Capsule, context_object: Any) -> dict:
	return _serialize_json(standin_component)

def _parse_component_instance_standin_func(context: PSTF_ImportContext, json_resource: dict, component_ref: PSTF_Component_Ref, standin_component: STFEXP_Collider_Capsule, context_object: Any):
...
class Handler_STFEXP_Collider_Capsule(STF_Handler_BoneComponent):
	"""Capsule collider"""
	stf_type = _stf_type
