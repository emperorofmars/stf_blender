...
def _stf_export(context: PSTF_ExportContext, component: STFEXP_Constraint_Twist, context_object: Any) -> tuple[dict, str]:
...
class Handler_STFEXP_Constraint_Twist(STF_Handler_BoneComponent):
