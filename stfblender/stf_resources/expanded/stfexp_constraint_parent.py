...
def _draw_component(layout: bpy.types.UILayout, context: bpy.types.Context, component_ref: PSTF_Component_Ref, context_object: Any, component: STFEXP_Constraint_Parent):
...
def _stf_export(context: PSTF_ExportContext, component: STFEXP_Constraint_Parent, context_object: Any) -> tuple[dict, str]:
...
def _set_component_instance_standin(context: bpy.types.Context, component_ref: PSTF_Component_Ref, context_object: Any, component: STFEXP_Constraint_Parent, standin_component: STFEXP_Constraint_Parent):
...
def _serialize_component_instance_standin_func(context: PSTF_ExportContext, component_ref: PSTF_Component_Ref, standin_component: STFEXP_Constraint_Parent, context_object: Any) -> dict:
	ret = {}
...
def _parse_component_instance_standin_func(context: PSTF_ImportContext, json_resource: dict, component_ref: PSTF_Component_Ref, standin_component: STFEXP_Constraint_Parent, context_object: Any):
	_get_component = preserve_component_reference(standin_component, _blender_property_name, context_object)
