...
def _draw_component(layout: bpy.types.UILayout, context: bpy.types.Context, component_ref: PSTF_Component_Ref, context_object: Any, component: VRC_AvatarColliders):
...
def _stf_export(context: PSTF_ExportContext, component: VRC_AvatarColliders, context_object: Any) -> tuple[dict, str]:
