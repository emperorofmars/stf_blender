...
class JsonFallbackData(STF_DataResourceBase):
...
def register():
	setattr(bpy.types.Collection, Handler_JsonFallbackData.blender_property_name, bpy.props.CollectionProperty(type=JsonFallbackData, options=set()))

def unregister():
	if hasattr(bpy.types.Collection, Handler_JsonFallbackData.blender_property_name):
		delattr(bpy.types.Collection, Handler_JsonFallbackData.blender_property_name)
