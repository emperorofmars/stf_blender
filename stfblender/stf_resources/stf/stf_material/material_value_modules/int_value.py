...
class STF_Material_Value_Int(STF_Material_Value_Base):
	number: bpy.props.IntProperty(name="Int")


def _import_material_value(context: STF_ImportContext, json_material: dict, blender_material: bpy.types.Material, json_resource: Any, value: STF_Material_Value_Int):
	value.number = json_resource


def _export_material_value(context: STF_ExportContext, json_material: dict, blender_material: bpy.types.Material, value: STF_Material_Value_Int) -> Any:
	return value.number
...
def _export_blender_animation(context: STF_ExportContext, blender_property_path: str, value: STF_Material_Value_Int) -> STFPropertyPathPart | None:
