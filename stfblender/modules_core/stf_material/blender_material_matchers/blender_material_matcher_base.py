...
def add_property(blender_material: bpy.types.Material, property_type: str, value_module: STF_Blender_Material_Value_Module_Base) -> STF_Material_Property:
	prop = blender_material.stf_material_properties.add()
	prop.property_type = property_type
	prop.multi_value = value_module.multi_value
	return prop


def add_value(blender_material: bpy.types.Material, property: STF_Material_Property, value_module: STF_Blender_Material_Value_Module_Base) -> tuple[STF_Material_Value_Ref, STF_Blender_Material_Value_Module_Base]:
