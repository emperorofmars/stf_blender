...
__all__ = ["STF_Component_Ref", "InstanceModComponentRef", "STF_ComponentResourceBase", "add_component", "import_component_base", "export_component_base", "STF_Component_Editmode_Resistant_Reference", "preserve_component_reference"]
...
def add_component(context_object: Any, blender_property_name: str, stf_id: str, stf_type: str, components_ref_property: Any = None, name = None) -> tuple[STF_Component_Ref, STF_ComponentResourceBase]:
	if(components_ref_property is None):
		...
		elif(hasattr(context_object, "stf_info")):
			components_ref_property = context_object.stf_info.stf_components
		else:
			raise NotImplementedError("Invalid code path")
...
def import_component_base(context: STF_ImportContext, component: STF_ComponentResourceBase, json_resource: dict, blender_property_name: str, context_object: Any):
