...
def _resolve_property_path_to_stf_func(context: STF_ExportContext, blender_property_path: str, value: STF_Material_Value_Color) -> tuple[list, Callable[[int, any], any], list[int]]:
