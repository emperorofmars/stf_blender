...
class STFAddComponentOperatorBase:
	...
	def get_components_ref_property(self, context) -> list[PSTF_Component_Ref]:
...
class STFEditComponentOperatorBase:
	...
	def get_components_ref_property(self, context: bpy.types.Context) -> list[PSTF_Component_Ref]:
		return self.get_property(context).stf_info.stf_components
